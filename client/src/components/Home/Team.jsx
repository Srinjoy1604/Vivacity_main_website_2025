...
function Team() {
  ...
  return (
    <>
      ...
      >
        <div className="w-[100%] absolute top-0 p-[5%] grid place-items-center">
          <img src={Title} className="w-[40%]"></img>
        </div>
        ...
        >
          {/* Thread */}
          <div
            className="top-[24.5885%] left-[24.7%] "
            style={{
              position: "absolute",
              width: `${(292 / 583) * 100}%`,
              height: `${(221 / 520) * 100}%`,
              ...
              transform: `rotate(1.38deg) ${
                showPins ? "translateY(0)" : "translateY(-100%)"
              }`,
              zIndex: "3",
          ...
          <div
            ...
            style={{
              ...
              backgroundSize: "cover",
              transform: `rotate(1.38deg) ${
                showPins ? "translateY(0)" : "translateY(-50%)"
              }`,
              zIndex: "3",
      ...
      >
        <div className="w-[100%] absolute top-[2%] p-[5%] grid place-items-center">
          <img src={Title} className="w-[80%]"></img>
        </div>
        {/* Purple Div */}
        <div
          style={{
          ...
          >
            ...
            <div
              style={{
                ...
                backgroundPosition: "center",
                transform: `rotate(1.38deg) ${
                  showThread ? "translateY(0)" : "translateY(-100%)"
                }`,
                zIndex: "3",
                opacity: showThread ? 1 : 0,
                transition: "all 0.6s ease-out",
