...
{
    return(
        <div className={`w-[100%] h-[100%] flex items-center align-middle justify-center ${styles.MascotBackground} max-[800px]:h-fit pt-[2%] pl-[2%] pr-[2%] pb-[6%]`}>
                ...
                <div className="w-[100%] py-[2%] ">
                    <div className={`${styles.NetraDiv} p-[6%] mb-[1%] pb-[10%] w-[100%] `}>
                        ...
                        <div className="w-[100% grid place-items-center">
                            <img src={NetraText} className="w-[70%] h-auto max-[800px]:w-[50%]">
                                </img>
                        </div>
                    </div>
                    <div className={`${styles.NetraMobile} grid place-items-center w-[100%] h-[100%] pl-[1.2%] pr-[1.2%] pb-[2.5%] hidden max-[800px]:block`}>
                    ...
                    <div className={`${styles.NetraOriginDiv} p-[5%] w-[100%]`}>
                        ...
                        <div className="w-[100%] h-[100%] pl-[2%] "><button className={`${styles.NetraButton} p-[2.5%] pl-[5%] pr-[5%] w-fit text-black text-[400]  text-[2rem] font-rfabb text-center max-[800px]:text-[1.25rem] `}>CHRONICLES OF NETRA</button>
                            </div>
                    </div>
                </div>
                <div className="w-[100%] h-[100%] max-[800px]:hidden">
                    <div className={`${styles.Mascot} grid place-items-center h-full w-[100%] py-[2%]`}><img src={NetraLarge} className="w-[100%] h-[100%]">
