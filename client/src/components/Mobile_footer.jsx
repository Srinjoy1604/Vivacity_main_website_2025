...
<div className="relative w-[80%] flex flex-col items-center justify-center top-[10.5%] ">
    ...
    <div className="flex flex-col items-center top-[0%] h-[55.55%] ">
      ...
      <p className="text-center  font-vetosans text-[1rem] text-black"
     >
    ...
    <div className="flex flex-col gap-[18%] items-center bottom-[0%] h-[35.87%] ">
      ...
      <div className="text-center text-black  h-[63.09%]">
        <p className="text-[1.0625rem] font-vetosans">For further queries:</p>
        <p className="text-[1.0625rem] font-vetosans">Ayush Dhanesha: +91 9998523792</p>
        <p className="text-[1.0625rem] font-vetosans">Shubhanshu Singhal: +91 8949024851</p>
      </div>
    </div>
  </div>
