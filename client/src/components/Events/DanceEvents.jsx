...
import Title1 from "../../assets/images/DanceTitle.webp";
import Title2 from "../../assets/images/DanceTitle2.webp";
import subtitle1 from "../../assets/images/Subheading.webp";
  ...
  return (
    <div>
      <div className="md:block hidden">
        <div
          className="bg-cover bg-center flex flex-col items-center pt-[6rem] max-[802px]:pt-[10rem] "
          style={{
        ...
        >
          {/* Content Div */}
          <div
            className=" items-center mt-[2rem]"
            style={{
              position: "absolute",
              height: "84.70%",
              width: "93.82%",
      ...
      <div className="md:hidden block">
        ...
        >
          ...
          >
            <p className="font-rfabb text-[1.5rem] sm:text-[1.4rem] xs:text-[1.0rem] xxs:text-[0.85rem] xxxs:text-[0.65rem] 270:text-[0.50rem] text-center overflow-hidden">
              {" "}
              1 lakh cash prize + 1.5 lakh worth prizes
            </p>
          </div>
