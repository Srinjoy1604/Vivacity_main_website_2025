    ...
    <div className="flex justify-center items-center gap-[2%] md:gap-[5%] mt-[2%]">
      {showRulebook && (
        <button
          ...
          className="transform hover:scale-105 transition-transform relative md:mr-[5%] w-[31.8%] md:w-[31.8%]"
        >
          <img
            src={textbox}
            alt="Download Rulebook"
            className="w-full h-[5.1vw] object-contain"
          />
      ...
      {showRegister && (
        <button
          ...
          className="transform hover:scale-105 transition-transform relative w-[31.8%] md:w-[31.8%]"
        >
          <img
            src={textbox}
            alt="Register"
