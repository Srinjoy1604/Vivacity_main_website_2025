            ...
            >
                ...
                <div className="flex flex-row w-[100%]  justify-between px-[3.1%]">
                    ...
                    <div  className=" relative w-[46.6%] h-auto">
                        ...
                        <img  src={Topleft} alt="streetdance"  className="w-[100%] h-[100%]" />
                        <div
                style={{
                  position: "absolute",
                  width: "37.43%",
                ...
                <p className="font-rfabb leading-tight align-middle 1280:text-[1.05vw] lg:text-[1.05vw] md:text-[1vw]  1400:text-[1.05vw] 1500:text-[1.05vw] 1600:text-[1.05vw] 1980:text-[1.05vw] text-start mt-[1%]  font-bold ">
                  ...
                  exhilarating beats. Let your spirits soar with street dance!
                    ...
                    <div className="relative w-[51.6%] h-auto">
                        <img src={Topright} alt="talnarang" className="w-[100%] h-[100%]" />
                         {/* Title topright */}
              <div
                style={{
                  position: "absolute",
              ...
              >
                ...
                <div className="flex flex-row w-[100%] mt-[2%] justify-between px-[3.1%]" >
                   {/* row 2  left*/}
                    ...
                    <img  src={MiddleLeft} alt="streetdance"  className="w-[100%] h-[100%] " />
                    {/* Title midleft */}
              <div
                style={{
                  position: "absolute",
              ...
              >
                <p className="font-rfabb leading-tight text-[1.2vw] font-bold ">
                  ...
                  your choreography in this dance battle.
                    ...
                    <img  src={MiddleRight} alt="streetdance"  className="w-[100%] h-[100%]" />
                    {/* Title middleright */}
              <div
                style={{
                  position: "absolute",
              ...
              >
                ...
                <div className="flex flex-row w-[100%] mt-[2%] justify-between px-[3.1%]">
                    ...
                    <img  src={BottomLeft} alt="streetdance"  className="w-[100%] h-[100%] " />
                     {/* Title bottomleft */}
              <div
                style={{
                  position: "absolute",
              ...
              >
                <p className="font-rfabb leading-tight text-[1.2vw] font-bold ">
                  ...
                  <br /> each other in this competition of melodies.
                    ...
                    <img  src={BottomRight} alt="streetdance"  className="w-[100%] h-[100%]" />
                    {/* Title bottomright */}
              <div
                style={{
                  position: "absolute",
